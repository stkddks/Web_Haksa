...
public class Function {
	...
	public void register(String protocol, BufferedReader input, Statement stmt, Connection conn, int cnt) throws IOException, SQLException{
		// 등록
		while(true) {
			System.out.println();
	...
	public void search(String protocol, BufferedReader input, Statement stmt, Connection conn, int cnt) throws IOException, SQLException{
		// 찾기
	...
	public void delete(String protocol, BufferedReader input, Statement stmt, Connection conn, int cnt) throws IOException, SQLException{
		// 삭제
	...
	public void list(String protocol, Statement stmt, Connection conn) throws IOException, SQLException{
